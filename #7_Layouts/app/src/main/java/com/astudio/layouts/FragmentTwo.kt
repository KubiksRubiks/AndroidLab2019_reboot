 ...
 * The fragment layout uses any group layouts exclude ConstraintLayout.
...
class FragmentTwo : Fragment() {
    ...
    companion object {
        fun newInstance(flightSchedule: FlightSchedule) : FragmentTwo {
            val args = Bundle().apply { putParcelable(MainActivity.FLIGHT_AGRS_KEY, flightSchedule) }
            val fragment = FragmentTwo().apply { arguments = args }
            return fragment
        }
    }
}
